...
h1, h2, h3, h4, h5, h6, p, label, span {{
    color: white !important; /* Makes all text white */
}}

.stApp {{
    color: white !important;
}}
/* Styling test result text (black) */
.test-result {{
...
models = {
    'diabetes': pickle.load(open('C:\Edunet_project\Models\Models\diabetes_model.sav', 'rb')),
    'heart_disease': pickle.load(open('C:\Edunet_project\Models\Models\heart_disease_model.sav', 'rb')),
    'parkinsons': pickle.load(open('C:\Edunet_project\Models\Models\parkinsons_model.sav', 'rb')),
    'lung_cancer': pickle.load(open('C:\Edunet_project\Models\Models\lungs_disease_model.sav', 'rb')),
    'thyroid': pickle.load(open('C:\Edunet_project\Models\Models\Thyroid_model.sav', 'rb'))
}
